	...
	return (
		<div className="container education">
			...
			<div>
				...
				<p>
					Description: I enrolled in the online Associate degree program while I
					was employeed at Breakthru Beverage. I was working full time and doing
					the online classes fulltime. It took about a year and a half to
					complete the program, but it was well worth it. I graduated with a 4.0
					GPA and Highest Honors.{" "}
				</p>
			</div>
